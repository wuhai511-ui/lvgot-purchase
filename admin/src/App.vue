...
.brand-mark { width: 52px; height: 52px; border-radius: 18px; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 22px; font-weight: 700; background: $gradient-brand; box-shadow: $shadow-sm; }
.brand-title { font-size: 18px; font-weight: 700; color: $text-color; }
.brand-subtitle { margin-top: 4px; font-size: 12px; color: $text-muted; }
.merchant-card { padding: 16px; margin-bottom: 18px; border-radius: $radius-md; background: linear-gradient(180deg, rgba(223,245,241,0.8) 0%, rgba(255,255,255,0.95) 100%); border: 1px solid rgba(215,229,225,0.9); }
.merchant-card__label { font-size: 12px; color: $text-muted; }
...
:deep(.sidebar-menu .el-menu-item), :deep(.sidebar-menu .el-sub-menu__title) { height: 46px; line-height: 46px; border-radius: 14px; color: $text-secondary; margin-bottom: 6px; }
:deep(.sidebar-menu .el-menu-item:hover), :deep(.sidebar-menu .el-sub-menu__title:hover), :deep(.sidebar-menu .el-menu-item.is-active) { background: rgba(223,245,241,0.9); color: $primary-strong; }
